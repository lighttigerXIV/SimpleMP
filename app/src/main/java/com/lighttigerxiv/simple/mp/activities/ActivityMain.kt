...
class ActivityMain : AppCompatActivity(){
    ...
    private var clSlideContent: ConstraintLayout? = null
    ...
    //Slide Player
    private lateinit var clSlidePlayer: ConstraintLayout
    ...
    private fun assignVariables(){
        ...
        clSlidePlayer = findViewById(R.id.clSlidePlayer_SidingPanel)
    ...
    private fun handleUserPlaylistUpdated(){

        fragmentUserPlaylist.onPlaylistUpdatedListener = object : FragmentUserPlaylist.OnPlaylistUpdatedListener {
    ...
    private val connection = object : ServiceConnection {
        ...
        override fun onServiceConnected(name: ComponentName?, service: IBinder?) {
            ...
            handleShuffleMusic()
            handleLoopMusic()
            handlePlaylistAddedFromService()
